...
export const quizQuestions: Record<string, QuizQuestion[]> = {
  ...
  'data-feature-evaluation': [
    ...
    },
    {
      id: 'df-quiz-11',
      algorithmId: 'data-feature-evaluation',
      question: 'KNN 中的 K 值属于什么？',
      options: ['超参数（由人提前设置）', '模型参数（由数据学习）', '标签', '样本'],
      correctIndex: 0,
      explanation: 'K值是典型的超参数——你在代码里写n_neighbors=5，模型不会自己改变这个数字。超参数是训练前由人设定的。',
    },
    {
      id: 'df-quiz-12',
      algorithmId: 'data-feature-evaluation',
      question: '决策树 max_depth 设置太大最可能导致什么？',
      options: ['过拟合——模型记住训练数据噪声', '欠拟合——模型学不到规律', '训练集消失', '标签自动改变'],
      correctIndex: 0,
      explanation: '树太深会记住训练数据的每个细节包括噪声，训练集几乎满分但测试集表现差。',
    },
    {
      id: 'df-quiz-13',
      algorithmId: 'data-feature-evaluation',
      question: '5 折交叉验证中，每轮用几份数据作为验证集？',
      options: ['1 份', '5 份', '0 份', '全部数据'],
      correctIndex: 0,
      explanation: 'K折交叉验证每轮用1份作验证集，剩余K-1份作训练集，轮流K次。',
    },
    {
      id: 'df-quiz-14',
      algorithmId: 'data-feature-evaluation',
      question: '交叉验证的主要作用是什么？',
      options: ['更稳定地评估模型表现', '代替标签', '删除所有特征', '让代码运行更快'],
      correctIndex: 0,
      explanation: '交叉验证通过多次评估取平均，减少单次划分的偶然性，让模型评估更稳定可靠。',
    },
    {
      id: 'df-quiz-15',
      algorithmId: 'data-feature-evaluation',
      question: '超参数和模型参数有什么区别？',
      options: ['超参数由人设定，参数由数据学习', '没有区别，只是名字不同', '超参数只能用于分类', '参数比超参数大'],
      correctIndex: 0,
      explanation: '超参数是训练前人为设定的（如K值、树深度），模型参数是训练过程中从数据自动学到的（如线性回归的权重w）。',
    },
    {
      id: 'df-quiz-16',
      algorithmId: 'data-feature-evaluation',
      question: '交叉验证是机器学习算法吗？',
      options: ['不是，它是一种模型评估方法', '是，它和KNN一样', '是，它只用于图像', '是，它代替决策树'],
      correctIndex: 0,
      explanation: '交叉验证不是算法，而是一种评估方法。它告诉你怎么更可靠地衡量模型好坏，不改变模型本身。',
    },
  ],
