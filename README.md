...
>
> **当前版本：v2.8.1** | 最近更新：8 门课程体系（2基础+6算法）、引导式问答、学习路径按难度重排、代码示例充实、逻辑回归/随机森林可视化
...
- 内置课程：8 门（2 门基础概念课 + 6 门算法课），面向零基础渐进式学习，按入门→中级难度编排
- 代码练习：8 道（每个算法 2 道）
- 测验题目：32 道（每个算法 8 道）
...
- 内置 4 个核心算法：线性回归、K 近邻算法、决策树、K-Means 聚类
...
7. **内容更完整**：4 个核心算法、8 道代码练习、32 道测验题，管理后台还能继续扩展题库。
