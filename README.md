...
>
> **当前版本：v2.8.2** | 最近更新：课程2升级10小节+10互动组件+评估调参模块+概念掌握度+引导思考前置+AlgorithmPage模块重排
...
- 内置课程：9 门（3 门基础概念课 + 6 门算法课），课程2已升级为10小节含超参数/交叉验证/数据泄露
...
- 每门课程配套选择题测验，当前共 78 道内置测验题（含基础课 30 道）
- 自动评分
- 提交后展示正确答案和解析
- 测验记录保存到本地
...
7. **内容更完整**：9 门课程、12 道代码练习(全部Pyodide)、78 道测验题、6 可视化+10 互动实验+20 图解，管理后台可持续扩展。
